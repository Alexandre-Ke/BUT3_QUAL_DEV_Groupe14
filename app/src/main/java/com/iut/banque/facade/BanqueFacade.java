...
public class BanqueFacade {
	 ...
	 *                                    dans le cas où le retrait n'est pas
	 *                                    autorisé (dépassement de
	 ...
	 *                                : Si l'id fourni en paramtre est déjà assigné
	 *                                à un autre
	 *                                compte de la base
	 * @throws IllegalFormatException
	 ...
	 * @throws TechnicalException
	 *                                   : Si l'id fourni en paramtre est déjà
	 *                                   assigné à un autre
	 *                                   compte de la base
	 * @throws IllegalFormatException
	 *                                   : si le numeroCompte n'est pas du bon
	 *                                   format
	 ...
	 * @throws TechnicalException
	 *                                   : si le compte est null ou si le compte
	 *                                   n'est pas un compte
	 *                                   persistant.
	 */
	 ...
	 */
	public void createManager(String nom, String prenom, String adresse, boolean male, String userId, String userPwd)
			throws TechnicalException, IllegalArgumentException, IllegalFormatException {
		if (loginManager.getConnectedUser() instanceof Gestionnaire) {
			banqueManager.createManager(nom, prenom, adresse, male, userId, userPwd);
		}
	}
	 ...
	 * @param numeroClient
	 * @throws IllegalOperationException
	 *                                   : si le numeroClient founri en paramètre
	 *                                   est déjà assigné à
	 *                                   un autre utilisateur de la base
	 * @throws TechnicalException
	 *                                   : Si l'id fourni en paramètre est déjà
	 *                                   assigné à un autre
	 *                                   utilisateur de la base
	 * @throws IllegalFormatException
	 * @throws IllegalArgumentException
	 */
	public void createClient(String nom, String prenom, String adresse, boolean male, String userId, String userPwd,
			String numeroClient)
			throws IllegalOperationException, TechnicalException, IllegalArgumentException, IllegalFormatException {
		if (loginManager.getConnectedUser() instanceof Gestionnaire) {
			banqueManager.createClient(nom, prenom, adresse, male, userId, userPwd, numeroClient);
		}
	}
	 ...
	 * @param u
	 * @throws IllegalOperationException
	 *                                   si l'user est null ou si l'utilisateur
	 *                                   n'est pas un
	 *                                   utilisateur persistant.
	 * @throws TechnicalException
	 *                                   si le manager à supprimer est le dernier
	 *                                   dans la base
	 */
	public void deleteUser(String userId) throws IllegalOperationException, TechnicalException {
		if (loginManager.getConnectedUser() instanceof Gestionnaire) {
			banqueManager.deleteUser(userId);
		}
	}
	 ...
	 * 
	 * @param compte
	 *                         : CompteAvecDecouvert correspondant au compte qu'on
	 *                         veut
	 *                         modifier
	 * @param nouveauDecouvert
	 *                         : double correspondant au nouveau montant de
	 *                         découvert qu'on
	 *                         veut assigner
	 * @throws IllegalFormatException
	 * @throws IllegalOperationException
	...
	public void updatePassword(String userId, String newPassword) throws IllegalOperationException {
		try {
			banqueManager.updatePassword(userId, newPassword);
	...
	public Utilisateur rechercherUtilisateurPourReinitialisation(String userId) {
		return banqueManager.rechercherUtilisateurPourReinitialisation(userId);
	}

	public void reinitialiserLeMotDePasse(String userId, String nouveauMotDePasse) throws TechnicalException {
		banqueManager.reinitialiserLeMotDePasse(userId, nouveauMotDePasse);
	}
