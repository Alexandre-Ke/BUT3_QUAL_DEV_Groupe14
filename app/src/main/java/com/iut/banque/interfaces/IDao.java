...
public interface IDao {
	 ...
	 *                                   : si le numéro de compte existe déjà
	 *                                   IllegalFormatException : si
	 *                                   l'appel du constructeur du
	 *                                   CompteSansDecouvert échoue
	 ...
	 *                            : si le numéro de compte existe déjà
	 *                            IllegalFormatException : si
	 *                            l'appel du constructeur du CompteSansDecouvert
	 *                            échoue
	 */
	 ...
	 *          CompteSansDecouvert)
	 * @throws TechnicalException
	 *                            , si le compte est null ou si le compte n'est pas
	 *                            un compte
	 *                            persistant.
	 */
	 ...
	 * @throws TechnicalException
	 *                            , si l'user est null ou si l'utilisateur n'est pas
	 *                            un
